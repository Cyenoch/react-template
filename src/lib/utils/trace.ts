...
export const getSpanAttributesFromResponse = (response: Response) => {
  return {
...
export const traceFetch = (handler: (request: Request) => Promise<Response> | Response) => {
...
export function runWithSpan<Args extends any[], R>(
  fn: (...args: Args) => R,
  options?: {
    name?: string;
